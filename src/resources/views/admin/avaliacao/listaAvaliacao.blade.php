...
<section class="admin-list-page">
  <div class="app-content-header admin-page-header">
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-6"><h1 class="mb-0 fs-3">Avaliações</h1></div>
        <div class="col-sm-6">
          ...
          <div class="card admin-data-card mb-4">
            <div class="card-header">
              <div class="row g-2 align-items-center">
                <div class="col-12 col-md-4"><h3 class="card-title">Avaliações cadastradas</h3></div>
                <div class="col-12 col-md-8">
                  <div class="d-flex flex-wrap justify-content-md-end gap-2">
                    ...
                    <button type="button" class="btn btn-sm btn-primary" disabled title="Disponível na próxima etapa">
            ...
            <div class="card-body p-0">
              <div class="table-responsive">
                <table class="table table-hover align-middle m-0">
                  <thead>
                    <tr>
                      <th>Id</th><th>Imagem</th><th>Título</th><th>Mensagem</th><th>Cliente</th><th>Estrelas</th><th>Status</th><th class="text-end">Ações</th>
                    </tr>
                  </thead>
                  <tbody>
                    ...
                    @forelse ($avaliacoes as $avaliacao)
                      <tr>
                        ...
                        <td><span class="admin-record-label">{{ $avaliacao->titulo_avaliacao }}</span></td>
                    ...
                    @empty
                      <tr><td colspan="8" class="text-center py-4 text-muted">Nenhuma avaliação encontrada.</td></tr>
                    @endforelse
                  </tbody>
                </table>
              </div>
            ...
            <div class="card-footer clearfix">
              <div class="float-start pt-1 fs-7 text-body-secondary">Total de avaliações: <strong>{{ $avaliacoes->count() }}</strong></div>
